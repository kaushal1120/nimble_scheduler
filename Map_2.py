'''
Rename this file to Map.py before you run nimble scheduler. Nimble for now pick only Map.py files
This map the words which are of length 5 and write to files.
'''
